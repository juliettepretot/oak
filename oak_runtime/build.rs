...
fn main() {
    ...
    // Copy introspection_browser_client files (generated by the runner) to the
    // out dir. In case these files don't yet exist, such as when running unit
    // tests, create placeholder files. This ensures unit tests etc can be run
    // without needing to build the frontend client assets.
